...
<head>
  ...
  <title>AdminSTI 1 | Starter</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/res/admin/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>STI</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Anélio Sauer</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Anélio Sauer - Web Developer
                  <small>Member since Jul. 2021</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
